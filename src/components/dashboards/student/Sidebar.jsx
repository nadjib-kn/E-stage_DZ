...
const Sidebar = () => {
  ...
  const { currentUser } = useAuth(); // Pull in the current user data globally

  const handleLogout = (e) => {
    e.stopPropagation(); // Prevents the profile click event from firing when clicking logout
    navigate('/login');
  };
