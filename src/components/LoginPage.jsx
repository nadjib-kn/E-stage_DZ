          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-md rounded-3xl overflow-hidden
                ...
                shadow-[0_30px_80px_-12px_rgba(0,0,0,0.35)]
                dark:shadow-[0_0_0_1px_rgba(255,255,255,0.07),0_30px_80px_-12px_rgba(0,0,0,0.8),0_0_60px_-15px_rgba(37,99,235,0.18)]"
            >
              ...
              <div className="p-8">
                ...
                <button
                  ...
                  className="absolute top-5 right-5 w-8 h-8 rounded-full flex items-center justify-center
                    ...
                    bg-slate-100 dark:bg-slate-800/60 hover:bg-slate-200 dark:hover:bg-slate-700/60 transition-all"
                  aria-label="Close"
                >
                ...
                <AnimatePresence mode="wait">
                  {forgotStep === 'email' ? (
                    ...
                    >
                      ...
                      <form onSubmit={handleForgotSubmit} className="flex flex-col gap-4">
                        ...
                        <button
                          ...
                          className="w-full bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 text-white text-sm font-bold py-3.5 rounded-full transition-all
                            shadow-[0_8px_20px_-6px_rgba(37,99,235,0.4)] dark:shadow-[0_8px_24px_-6px_rgba(59,130,246,0.35)]
                        ...
                        <button
                          type="button"
                          onClick={closeForgotModal}
                          className="w-full text-sm font-semibold text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 py-2 transition-colors"
                        >
                          Back to Sign In
                        </button>
                      </form>
                    ...
                    >
                      ...
                      <span className="text-sm font-bold text-blue-600 dark:text-blue-400 mb-6 break-all">
                        {forgotEmail}
                      </span>
                      <p className="text-xs text-slate-400 dark:text-slate-500 leading-relaxed mb-8">
                      ...
                      <button
                        ...
                        className="mt-3 text-sm font-semibold text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 transition-colors"
                      >
